...
class WebSearchNode(BaseNode):
    ...
    def _define_required_credentials(self, parameters: Optional[Dict[str, Any]] = None) -> List[str]:
        """
        Define required credentials for WebSearchNode.
        Returns the credentials needed for Tavily web search service.
        """
        return ["TAVILY_API_KEY"]
    
    def _define_category(self) -> str:
        """Define category for WebSearchNode"""
        return "Search"
        ...
        return NodeStyling(
            ...
            <div class="web-search-node-container">
                ...
                <div class="web-search-content">
                    ...
                    <div class="web-search-subtitle">SEARCH ONLINE</div>
                </div>
            </div>
            """,
            custom_css="""
            ...
            .web-search-icon { margin-right: 12px; flex-shrink: 0; color: #3b82f6; display: flex; align-items: center; }
            .web-search-icon svg { width: 20px; height: 20px; }
            .web-search-content { flex: 1; display: flex; flex-direction: column; justify-content: center; }
            .web-search-title { font-size: 13px; font-weight: 600; color: #ffffff; margin-bottom: 2px; line-height: 1.2; }
            .web-search-subtitle { font-size: 11px; color: #3b82f6; opacity: 0.9; line-height: 1.2; font-weight: 700; letter-spacing: 0.5px; text-transform: uppercase; }
            """,
            icon="<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" class=\"lucide lucide-search\"><circle cx=\"11\" cy=\"11\" r=\"8\"/><path d=\"m21 21-4.3-4.3\"/></svg>", subtitle="SEARCH ONLINE", background_color="#1f1f1f", border_color="#3b82f6", text_color="#ffffff",
        ...
        return NodeUIConfig(
            ...
            dialog_config=DialogConfig(
                ...
                icon="""<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" stroke="#3b82f6" stroke-width="2" fill="none"/>
                </svg>""",
                icon_color="#3b82f6",
